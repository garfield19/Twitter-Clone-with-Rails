...
$(“#like_btn”).removeClass(‘glyphicon-heart-empty’).addClass(‘glyphicon-heart’);
$(“#like_”).attr(“href”, ‘/updates//unlike’);
(function() {
  ...
  Notifications = (function() {
    ...
    Notifications.prototype.handleSuccess = function(data) {
      ...
      items = $.map(data, function(notification) {
        return "<li><a class='dropdown-item' href='#'>" + notification.actor + " " + notification.action + " " + notification.notifiable.type + "</a></li>";
      });
